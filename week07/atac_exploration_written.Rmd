...
Bam file: read with sequence on genome
bigWig file: same as ban + contains additional info like coverage or something else
...
# we renormalize using border backgrounds (by default normlalized by coverage)
...
>>>>>>> 2eb0d1856b4f33b20d710349b8730ee393aa5257
```
...
for Mono centers: nucleosome after promoter is always positioned nicely
