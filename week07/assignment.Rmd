...
```{r}
#create mono_cuts
epiwraps::bam2bw(bam, output_bw = "mono_cuts.bw", paired=TRUE, binWidth = 1L, type="centers", minFragLength = 140, maxFragLength = 220, shift=c(4L, -5L), forceSeqlevelsStyle = "Ensembl")
```
