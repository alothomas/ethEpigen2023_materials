...
More protein binding when low protein is added to the sample -> Due to Normalization
...
Strongs region change the least -> with low [protein], high affinity complex can bind more

Check control heatmap difference to know if normalization method is efficient
